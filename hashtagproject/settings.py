"""
Django settings for hashtagproject project.
...
SECRET_KEY = 'n&o=kq5c^6-@f^qzm#akf5*4vt801cb*ndh-!%ln1w3c#(hb4b'
...
ROOT_URLCONF = 'hashtagproject.urls'
...
WSGI_APPLICATION = 'hashtagproject.wsgi.application'
